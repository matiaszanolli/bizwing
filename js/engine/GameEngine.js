...
import { calculateDistance, formatMoney, clamp, generateId } from '../utils/helpers.js';
...
export class GameEngine {
    ...
    createRoute(fromId, toId, aircraftId, flightsPerWeek) {
    ...
    calculateRouteCompetition(route) {
        let competitors = 0;
    ...
    estimateRouteProfitability(route) {
